...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 23, 2021 at 12:25 AM
...
(47, 'Stenly Samberi', 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'Stenly Samberipreview-xl.jpg', '343434342323', 'owner', 'Jayapura, Papua', 'Wednesday,08-Wed-2021'),
...
(9, 11, '8994016009664', 'Hand Sanitizer', 'b2tBlA-Jaya.jpg', 0, 'Pendding'),
(10, 0, '', '', 'kpDh6A-Jaya.jpg', 0, 'Pendding');
...
(26, 47, 'Halleuy', 'Halleuy20210818112102_IMG_3721.JPG', 'Thursday,09-Thu-2021', 'tidak'),
...
--
ALTER TABLE `akun`
  MODIFY `idAkun` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;

--
-- AUTO_INCREMENT for table `tbl_barang`
--
ALTER TABLE `tbl_barang`
  MODIFY `id_barang` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;

--
-- AUTO_INCREMENT for table `tbl_barcode_barang`
--
ALTER TABLE `tbl_barcode_barang`
  MODIFY `id_barcode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `tbl_info`
  MODIFY `id_info` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `tbl_merk_barang`
  MODIFY `id_merk_barang` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `tbl_nota`
--
ALTER TABLE `tbl_nota`
  MODIFY `id_penjualan_m` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `tbl_penjualan_detail`
--
ALTER TABLE `tbl_penjualan_detail`
  MODIFY `id_penjualan_d` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=495;
...
--
ALTER TABLE `tmp_jual`
  MODIFY `id_penjualan_d` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=608;
COMMIT;
