...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Add Barcode</h4>
        </div>
    </div>
</div>     
<!-- end page title -->
...
<div class="row">
    ...
    if (isset($_POST['keyword'])) {
        ...
        $product = mysqli_query($koneksi,"SELECT tbl_barcode_barang.*,tbl_satuan_produk.nama_satuan FROM tbl_barcode_barang INNER JOIN tbl_satuan_produk ON tbl_barcode_barang.id_satuan = tbl_satuan_produk.id_satuan ORDER BY tbl_barcode_barang.id_barcode DESC");
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card-box product-box">
                ...
                <div class="product-action">
                    <a data-toggle="modal" data-target="#EditBarcode<?php echo $code['id_barcode']?>" href="#" class="btn btn-success btn-xs waves-effect waves-light"><i class="mdi mdi-pencil"></i></a>
                    ...
                    <?php 
                        if (($code['join_ket']) == "Pendding") {
                           ?>
                             ...
                             <a href="gudang/control.php?del=<?php echo $code['id_barcode']?>" class="btn btn-danger btn-xs waves-effect waves-light"><i class="mdi mdi-close"></i></a>
   ...
   ?>
     ...
     <div class="col-md-12 col-xl-3">
        <div style="padding:20px;" class="alerts alert-warning" role="alert">
            <i class="mdi mdi-alert-outline mr-2"></i> Data Stok Barang <strong>Habis</strong> Silakan hubungi owner untuk penambahan Stok Barang!
        </div>
    </div>
