                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-6">
                        <div class="text-md-right">
                            <button type="button" data-toggle="modal" data-target="#add-category-modal" class="btn btn-danger waves-effect waves-light mb-2 mr-2"><i class="mdi mdi-account mr-1"></i> Add Category</button>
                ...
                <div class="table-responsive">
                    <table class="table table-centered table-nowrap table-borderless table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            $akun = mysqli_query($koneksi,"SELECT tbl_kategori_barang.*, akun.nama FROM tbl_kategori_barang INNER JOIN akun ON tbl_kategori_barang.idAkun = akun.idAkun ORDER BY tbl_kategori_barang.id_kategori_barang DESC LIMIT $halaman_awal,$batas");
                            $no = $halaman_awal + 1;
                            ...
                            if (mysqli_num_rows($akun)>0) {
                                ...
                                while ($i = mysqli_fetch_array($akun)) {
                                 ...
                                 <tr>
                                    ...
                                    <td class="table-user">
                                        <img src="assets/images/category/<?php echo $i['img']?>" alt="table-user" class="mr-2 rounded-circle">
                                        <a href="javascript:void(0);" class="text-body font-weight-semibold"><?php echo $i['kategori']?></a>
                                ...
                                <td>
                                    ...
                                    data-toggle ="modal" data-target="#editCategory<?php echo $i['id_kategori_barang']; ?>"
                                    href="" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>




                                    <a href="category/control.php?del=<?php echo $i['id_kategori_barang']?>" class="action-icon"> <i class="mdi mdi-delete"></i></a>
                                </td>
                            </tr>
                            <?php include 'modalView/EditCategory.php';?>
