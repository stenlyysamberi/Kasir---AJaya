  <form method="POST" action="category/control.php?edit=<?php echo $i['id_kategori_barang'];?>" enctype="multipart/form-data">

    <div id="editCategory<?php echo $i['id_kategori_barang']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    ...
                    <center>
                       <div class="col-md-4">
                          <img width="100" height="100" class="rounded-circle "  src="assets/images/category/<?php echo $i['img'];?>">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="nama" name="nama" required="required" class="form-control" value="<?php echo $i['kategori'];?>"  placeholder="Enter Text">
                        </div>
                    </div>
                </div>
